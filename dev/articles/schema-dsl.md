...
|----|----|
| [`schema_check()`](https://hongyuanjia.github.io/schemate/dev/reference/schema_check.md) | `check` |
| [`schema_ref()`](https://hongyuanjia.github.io/schemate/dev/reference/schema_ref.md) | `$ref` |
| [`schema_all()`](https://hongyuanjia.github.io/schemate/dev/reference/schema_all.md) | `all` |
| [`schema_any()`](https://hongyuanjia.github.io/schemate/dev/reference/schema_any.md) | `any` |
| [`schema_one()`](https://hongyuanjia.github.io/schemate/dev/reference/schema_one.md) | `one` |
| [`schema_not()`](https://hongyuanjia.github.io/schemate/dev/reference/schema_not.md) | `not` |
| [`schema_group()`](https://hongyuanjia.github.io/schemate/dev/reference/schema_group.md) | `groups[]` |
